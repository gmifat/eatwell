    <?php ?>
    <h2><?= $pageTitle ?></h2>
    <form action="index.php?controller=origins&action=add" method="post"  enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <input class="col-sm-10" type="input" class="form-control" id="position" name="position" value="<?= isset($_SESSION['old_inputs']) ? $_SESSION['old_inputs']['position'] : '' ?>">
        </div>
